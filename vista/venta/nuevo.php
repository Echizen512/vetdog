    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="../panel-admin/administrador">  </a>
            </div>
...
$query = "SELECT products.id_prod, products.codigo, products.foto, products.nompro, products.stock, products.preciC AS precio_compra, products.estado, products.fere 
          FROM products 
        ...
        <tbody>
            <?php while ($r = $products->fetch_object()): ?>
                <tr>
                    ...
                    <td class="text-center"><?php echo htmlspecialchars($r->codigo); ?></td>
