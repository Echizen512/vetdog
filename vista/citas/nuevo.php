              ...
              <form method="POST" autocomplete="off">
                ...
                ?>
                  <div class="col-sm-12">
                    ...
                    <div class="form-group">
                      <div class="form-line">
                        <input type="text" name="dni" class="form-control" placeholder="Ingrese la cédula" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" maxlength="8"/>
                      </div>
                    </div>
                  </div>
                  
                  <div class="container-fluid my-5" align="center">
                    <button class="btn bg-blue mx-auto" name="search">BUSCAR <i class="material-icons">search</i></button>
                  </div>
                                      ...
                                      foreach ($results as $key => $va) { ?>
                                        <tr>
                                          ...
                                          <td style="display: flex;justify-content: center;">
                                            <button value="<?= $va['id_pet'] ?>" type="button" class="btn-select-pet btn btn btn-circle waves-effect waves-circle waves-float" style="display: grid;place-items: center;"><img src="./../../assets/icons/FluentCheckboxUnchecked12Regular.svg" style="width: 100%;height: 100%;transform: scale(1.5);"></button>
                                          </td>
                                        </tr>
                                      <?php
                                        }
                ...
                <div class="container-fluid">
                  ...
                  <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
                    <a type="button" id="btn-clear" href="../../folder/veterinarios" class="btn bg-red"><i class="material-icons">cancel</i> LIMPIAR </a>
                  </div>

                  <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
                    <button type="button" id="btn-add" class="btn bg-blue" name="agregar" style="display: flex;justify-content: center;align-items: center;">IR A CONSULTA <img src="./../../assets/icons/MaterialSymbolsArrowForward.svg" alt="arrow" style="width: 25px;height: 25px;"></button>
                  </div>
                </div>
                  <?php } ?>
                </div>
...
if (isset($_POST["search"])) { 
  ...
  <?php 
    ...
    if($results->num_rows > 0) {
      ...
      ?><script>location.href = './nuevo.php'</script><?php
    } else { ?>
      <script>
...
<?php 
  if(isset($_GET['clear-session'])) {
    if(isset($_SESSION['search_owner'])) unset($_SESSION['search_owner']);
  }
?>
</body>
</html>