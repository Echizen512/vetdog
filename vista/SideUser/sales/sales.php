                ...
                <div class="card">
                    ...
                    <div class="body">
                        <div class="table-responsive">
                            <table id="tabla-compras" class="table table-bordered table-striped table-hover dataTable js-exportable">
                                <thead>
                                    <tr>
                                    ...
                                    <?php foreach ($compras as $key => $compra): ?>
                                        <tr>
                                            ...
                                            <td style="display: flex; justify-content: center; gap: 5px;">
                                                <a href="generar_pdf.php?id_venta=<?= $compra['id_venta']; ?>" class="btn bg-blue btn-circle waves-effect waves-circle waves-float" target="_blank">
