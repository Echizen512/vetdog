                    ...
                    <div class="row clearfix">
                      <div class="col-sm-6">
                        ...
                        <div class="form-group">
                          <div class="form-line">
                            <input type="text" value="<?php echo $d->dnivet; ?>" name="dnivet" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" maxlength="8" required class="form-control" placeholder="Cédula de identidad..." />
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-sm-6">
                        ...
                        <div class="form-group">
                          <div class="form-line">
                            <input type="text" value="<?php echo $d->nomvet; ?>" name="nomvet" class="form-control" placeholder="Nombres..." onKeypress="if(!isNaN(event.key)) return event.returnValue = false" required/>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-sm-6">
                        ...
                        <div class="form-group">
                          <div class="form-line">
                            <input type="text" value="<?php echo $d->apevet; ?>" name="apevet" class="form-control" onKeypress="if(!isNaN(event.key)) return event.returnValue = false" placeholder="Apellidos..." required/>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-sm-6">
                        ...
                        <div class="form-group">
                          <div class="form-line">
                            <input type="text" value="<?php echo $d->direcc; ?>" name="direcc" class="form-control" placeholder="Direccion..." required/>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-sm-6">
                        ...
                        <div class="form-group">
                          <div class="form-line">
                            <input type="password" name="password" class="form-control" placeholder="Cambiar contraseña..." />
                          </div>
                        </div>
                      </div>
                    </div>
