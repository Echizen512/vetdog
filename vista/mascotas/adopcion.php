                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <?php if ($estado == 'pendiente'): ?>
                                                        <button class="btn btn-success btn-sm" onclick="cambiarEstado(<?php echo $solicitud['id_solicitud']; ?>, 'aceptada')">
                                                            <i class="fas fa-check"></i>
                                                        </button>
                                                        <button class="btn btn-danger btn-sm" onclick="cambiarEstado(<?php echo $solicitud['id_solicitud']; ?>, 'rechazada')">
