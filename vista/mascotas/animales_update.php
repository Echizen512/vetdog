      ...
      <div class="menu">
        <ul class="list">
          ...
          <li>
            ...
            <ul class="ml-menu">
              <li><a href="./../audit/mostrar.php">Mostrar</a></li>
            </ul>
          </li>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        <div class="form-line">
                          ...
                          <input type="text" name="nomas" class="form-control" value="<?= $animal['nombre'] ?>"
                            required />
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        <div class="form-line">
                          ...
                          <input type="text" name="condicion" class="form-control" value="<?= $animal['condicion'] ?>"
                            required />
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="form-group">
                        <div class="form-line">
                          ...
                          <select name="estado" class="form-control" required>
                            <option value="disponible" <?= $animal['estado'] === 'disponible' ? 'selected' : '' ?>>
                              Disponible</option>
                            <option value="no disponible" <?= $animal['estado'] === 'no disponible' ? 'selected' : '' ?>>No
                              disponible</option>
                          </select>
                        </div>
                      </div>
