                ...
                <?php foreach ($data as $d): ?>
                  <form method="POST">
                    <div class="row clearfix">
                      <div class="col-sm-6">
                        ...
                        <div class="form-group">
                          <div class="form-line">
                            <input type="text" value="<?php echo $d->dni_due; ?>" name="dni_due"
                              onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;"
                              maxlength="8" class="form-control" placeholder="Cédula de identidad..." required />
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-sm-6">
                        ...
                        <div class="form-group">
                          <div class="form-line">
                            <input type="text" value="<?php echo $d->nom_due; ?>" name="nom_due"
                              onKeypress="if(!isNaN(event.key)) return event.returnValue = false" class="form-control"
                      ...
                      <div class="col-sm-6">
                        ...
                        <div class="form-group">
                          <div class="form-line">
                            <input type="text" value="<?php echo $d->ape_due; ?>" name="ape_due"
                              onKeypress="if(!isNaN(event.key)) return event.returnValue = false" class="form-control"
                      ...
                      <div class="col-sm-6">
                        ...
                        <div class="form-group">
                          <div class="form-line">
                            <input type="email" value="<?php echo $d->correo; ?>" name="correo" required
                      ...
                      <div class="col-sm-6">
                        ...
                        <div class="form-group">
                          <div class="form-line">
                            <input type="text" value="<?php echo $d->direc; ?>" name="direc" required class="form-control"
                    ...
                    <div class="container-fluid" align="center">
                      ...
                      <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
                        <a type="button" href="../../folder/clientes" class="btn bg-red"><i
