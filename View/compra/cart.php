                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            if (isset($_SESSION["cart"]) && !empty($_SESSION["cart"])):
                                    ...
                                    <form class="form-horizontal" method="post" action="process.php">
                                        <div class="form-group">
                                            <div class="text-center">
                                                <button type="submit" class="btn btn-success" style="border-radius: 30px;">Terminar Compra</button>
                                        ...
                                        <div class="col-md-2" id="id_prove" style="display:none;">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control form-control-line" required="" id="id_prove"
                                                    name="id_prove">
                                                </select>
                                            </div>
                                        </div>
                                ...
                                <?php endif; ?>
                                <br>
                                <h3>Proveedor <a style="margin-left:35px; border-radius: 30px;" href="#new" data-toggle="modal" title="New"
                                        class="btn btn-primary"><i class="material-icons">add_circle</i> Nuevo</a>
                                    <?php include('../compra/modal.php'); ?></h3>
