...
<body class="theme-red">
              ...
              <form method="POST" autocomplete="off">
                    ...
                    <div class="form-group">
                      <div class="form-line">
                        <label class="control-label">Nombre de la Categoría<span class="text-danger">*</span>
                          <input type="text" name="nomcate" class="form-control" placeholder="Nombre de la Categoría..."
                            style="width: 600%;" required />
                      </div>
                    </div>
                  </div>
                </div>
                <div class="container-fluid" align="center">
                  ...
                  <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
                    <a type="button" href="../../folder/categorias" class="btn bg-red"><i
  ...
  if (isset($_POST["add"])) {
    ...
    $sql = "SELECT id_cate FROM category WHERE nomcate = '$nomcate'";
    if (mysqli_num_rows(mysqli_query($conn, $sql)) > 0) { ?>
      <script>
        swal("¡Error!", "¡Ya existe la categoría a agregar!", "error");
      </script>
      <?php
      exit;
    }
    $now = date('Y-m-d');
    $sql = "INSERT INTO category(nomcate,fere) VALUES ('$nomcate','$now')";
